      ...
      <div className=" container mx-auto max-w-[1164px] px-3  md:py-[50px] mb-[39px] md:mt-[50px]">
        <div className="md:flex  items-center justify-between md:justify-between mt-[50px]">
          <div className="flex justify-center md">
            <p
              data-aos="zoom-in-up"
              className="sm:text-[40px] text-[32px] z-20 font-bold ff-recharge text-center md:text-start sm:leading-[52px] text-[#ffffff] max-w-[517px]"
            >
          ...
          <span
            data-aos="zoom-in-up"
            className="flex justify-center py-5 md:py-0"
          >
            <Samebtn text="Get Started" />
          </span>
        </div>
      </div>
      <img className="  absolute right-0 top-0" src={ep_r} alt="elpp" />
