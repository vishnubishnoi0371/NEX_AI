          ...
          <div className="  max-w-[1346px] px-3 border-[1px] pb-5 md:pb-0 border-white rounded-[24px] whats_bg  bg-no-repeat bg-center">
            <div className="flex md:flex-row flex-col-reverse  items-center justify-center flex-wrap lg:flex-nowrap min-h-[810px]  -mx-3 xl:px-[45px]">
              <div className=" lg:w-1/2 w-full px-3 ">
                <p
                  data-aos="zoom-in-up"
                  className=" text-[32px] sm:text-[40px] ff-recharge font-bold text-[#02CDCF] pt-5 lg:pt-0 leading-[50.5px]  mb-2"
                >
                  What is NexAi?
                </p>
                <p
                  data-aos="zoom-in-up"
                  className="text-base font-pop font-normal  text-[#b4b4b4] leading-[25.5px] lg:max-w-[564px] mb-2"
                >
                ...
                <p
                  data-aos="zoom-in-up"
                  className="text-base font-pop font-normal  text-[#b4b4b4] leading-[25.5px] lg:max-w-[564px] mb-4 md:mb-[40px]"
                >
              ...
              <div className=" lg:w-5/12 w-full px-3">
                <img
                  data-aos="zoom-in-up"
                  className="w-100  mix-blend-color-dodge"
                  src={AI}
                  alt="ai_img"
                />
              </div>
