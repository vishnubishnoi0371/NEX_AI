    ...
    <div id="about" className="relative">
      <div className=" container mx-auto max-w-[1364px] px-3  sm:pt-[30px] mt-[30px]">
        <div className="  max-w-[1340px] relative mx-auto px-3 border-[1px] border-white scroll_bg object-cover overflow-hidden rounded-[32px]  min-h[800px]  bg-no-repeat bg-center">
          <div className="flex flex-col items-center justify-center pb-[40px mb-[40px] pt-[40px]">
            <p
              data-aos="zoom-in-up"
              className=" text-[32px] sm:text-[40px] font-bold ff-recharge leading-[51px] text-white text-center mb-2 sm:mb-4 sm:mt-[40px]"
            >
              Unique features
            </p>
            <p
              data-aos="zoom-in-up"
              className=" text-[14px] sm:text-base text-center font-normal mb-[-30px] sm:mb-0 font-pop  !opacity-[0.7] sm:leading-[26px] text-white  max-w-[397px]"
            >
      ...
      <div className="sm:pt-[50px] relative mt-[10px]">
        ...
        <div className="flex items-center justify-center flex-col mt-[50px] sm:pt-[50px] sm:pb-[47px]">
          ...
          <p
            data-aos="zoom-in-up"
            className="max-w-[997px] z-30 text-[14px]  sm:text-base font-normal font-pop leading-[25.4px] text-center text-[#ffffff] !opacity-[70%]"
          >
        ...
        <div className="flex items-center justify-center mt-[47px]">
          <p
            data-aos="zoom-in-up"
            className="text-xl z-30 font-bold ff-recharge text-center pb-[40px] sm:pb-[60px] leading-[32px] text-white max-w-[684px]"
          >
        ...
        >
          <Slider {...settings}>
            <div data-aos="zoom-in-up" className="px- ">
            ...
            <div data-aos="zoom-in-up" className="sm:mt-[50px] sm:pt-[50px]  ">
