      ...
      <div className=" container mx-auto max-w-[1246px] px-3 ">
        <div className="flex md:flex-row flex-col-reverse items-center justify-center flex-wrap  -mx-3 ">
          <div className=" md:w-1/2 w-full px-3 pt-8 md:pt-0">
            <img className=" mx-auto w-full" src={hand} alt="" />
          </div>
          <div className=" md:w-1/2 w-full px-3 lg:ps-[40px]">
            <p className="text-[32px] sm:text-[40px] ff-recharge font-bold text-[#02CDCF] leading-[normal] sm:leading-[50.5px] md:max-w-[517px] mb-2">
              Ai-Powered Home Assistant
            </p>
            <p className="sm:text-base z-30 text-[14px] font-pop font-normal  text-[#b4b4b4] leading-[25.5px] md:max-w-[517px] mb-[6px]">
            ...
            <p className="sm:text-base z-30 text-[14px] font-pop font-normal  text-[#b4b4b4] leading-[25.5px] md:max-w-[517px] mb-3 sm:mb-[40px]">
